...
MODEL_ID = os.environ.get('anthropic.claude-3-sonnet-20240229-v1:0', 'anthropic.claude-3-5-sonnet-20240620-v1:0')


def build_chain():
  region_name = boto3.Session().region_name
  client = boto3.client('bedrock-runtime', region_name=region_name or 'us-east-1')
  return client
